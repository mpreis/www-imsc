<div id="fb-feeds" class="row">
          <div class="col-sm-6">
            ...
            <div class="my_section fb-feed text-center">
              Treffpunkt für das 
              <a href="http://www.karting-paradies.de/" target="_blank" class="btn btn-warning">Go-Kart</a>
              fahren morgen, <h3>SA 5.1.</h3> ist beim 
              <a href="https://www.google.at/maps/place/Diermair+GmbH/@48.1660431,13.2659588,17z/data=!3m1!4b1!4m2!3m1!1s0x47743b8eabb892c7:0xc57ed07ecbced19d?hl=de" class="btn btn-warning">Land Lebt Auf in Kirchheim</a> 
              (bzw. etwas dahinter Richtung Reich) <h3>um 14 Uhr</h3>

              Wir freuen uns schon sehr und hoffen ihr seit motiviert :D
            </div>
          </div>
          <div class="col-sm-5 col-sm-offset-1">
            ...
            <div class="my_section fb-feed">
              <h3>WICHTIG:</h3>
              <ul>
                <li><h6>Die Februar-Sitzung findet in Aspach beim <a href="http://www.streff.at/" target="_blank" class="btn btn-warning">s'Treff</a> statt (wie gewohnt 20 Uhr).</h6></li>
                <li>Die Jahresabschlussfeier findet am Sa, 09.01.2016 um 19 Uhr in Neuhofen beim Sternbauer statt.</li>
